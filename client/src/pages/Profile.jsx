...
export default function Profile() {
  ...
  const [isRegisteredCProgramming, setIsRegisteredCProgramming] =
    useState(false);
  ...
  const courses = [
    {
      name: "Cpp",
      stateSetter: setCurrentLevelCpp,
      regSetter: setIsRegisteredCpp,
    },
    {
      name: "C Programming",
      stateSetter: setCurrentLevelCProgramming,
      regSetter: setIsRegisteredCProgramming,
    },
    {
      name: "Csharp",
      stateSetter: setCurrentLevelCsharp,
      regSetter: setIsRegisteredCsharp,
    },
  ];
